...
The outcome data $Y$ is simulated from `y <- rnorm(n, 0.4 + 0.8 * a + 0.3 * x + (x^2 - 0.25), sd = 1)`.
...
The treatment group is simulated from `prob <- inv_logit(-0.25 + 0.5 * x + (x^2 - 0.25))`. Everything else are the same. 
